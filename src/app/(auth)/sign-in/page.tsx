    ...
    <div className="space-y-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="text-right">
          <Link href="/forgot-password" className="text-[#2563eb] text-xs hover:underline font-medium">
            Forgot password?
          </Link>
        </div>

        <LoadingButton type="submit" loading={loading} loadingLabel="Signing in…"
      ...
      <p className="text-center text-neutral-500 text-sm">New here? <Link href="/sign-up" className="text-[#2563eb] hover:underline font-medium">Create account</Link></p>
    </div>
  );
}
