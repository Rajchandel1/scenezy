...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="app-shell min-h-screen flex items-center justify-center px-5 py-10 relative overflow-hidden">
      ...
      <div className="w-full max-w-[370px] space-y-8 relative z-10">
        ...
        <p className="text-center text-neutral-600 text-xs">Secure access powered by Scenezy</p>
      </div>
    </div>
  );
}
