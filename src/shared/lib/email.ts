...
<div style="max-width:400px;margin:0 auto;padding:40px 20px;box-sizing:border-box">
  ...
  <div style="background:#171717;border:1px solid #262626;border-radius:16px;padding:24px;box-sizing:border-box">
    ...
    <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
      <a href="${url}" style="display:inline-block;width:100%;background:#c4f000;color:#0a0a0a;font-weight:700;text-align:center;padding:14px 0;border-radius:12px;text-decoration:none;font-size:15px;box-sizing:border-box">Verify Email</a>
    </td></tr></table>
  </div>
...
<div style="max-width:400px;margin:0 auto;padding:40px 20px;box-sizing:border-box">
  ...
  <div style="background:#171717;border:1px solid #262626;border-radius:16px;padding:24px;box-sizing:border-box">
    ...
    <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
      <a href="${url}" style="display:inline-block;width:100%;background:#c4f000;color:#0a0a0a;font-weight:700;text-align:center;padding:14px 0;border-radius:12px;text-decoration:none;font-size:15px;box-sizing:border-box">Reset Password</a>
    </td></tr></table>
  </div>
</div></body></html>`;
}
...
<div style="max-width:400px;margin:0 auto;padding:40px 20px;box-sizing:border-box">
  ...
  <div style="background:#171717;border:1px solid #262626;border-radius:16px;padding:24px;text-align:center;box-sizing:border-box">
    ...
    <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
      <a href="${url}" style="display:inline-block;background:#c4f000;color:#0a0a0a;font-weight:700;padding:12px 32px;border-radius:12px;text-decoration:none;font-size:14px">View Passes</a>
    </td></tr></table>
  </div>
</div></body></html>`;
}
